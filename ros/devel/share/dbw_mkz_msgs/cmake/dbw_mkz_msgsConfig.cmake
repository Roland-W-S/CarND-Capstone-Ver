...
if("TRUE" STREQUAL "TRUE")
  set(dbw_mkz_msgs_SOURCE_PREFIX /home/student/CarND-Capstone/ros/src/dbw_mkz_msgs)
  set(dbw_mkz_msgs_DEVEL_PREFIX /home/student/CarND-Capstone/ros/devel)
  ...
  set(dbw_mkz_msgs_INSTALL_PREFIX /home/student/CarND-Capstone/ros/install)
...
if(NOT "/home/student/CarND-Capstone/ros/devel/include " STREQUAL " ")
  set(dbw_mkz_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/student/CarND-Capstone/ros/devel/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'dbw_mkz_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/student/CarND-Capstone/ros/src/dbw_mkz_msgs/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/student/CarND-Capstone/ros/devel/lib;/opt/ros/kinetic/lib)
